    ...
    <div class="panel-body" id="patients_dv_container">
        ...
        @show    					
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <select class="form-control" id="gender" name="gender" required>
                                    <option value="@yield('gender')">@yield('gender')</option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <input maxlength="40" type="date" class="form-control" name="birthdate" id="birthdate" placeholder="MM/DD/YYYY" value="@yield('birth_date')" required>
                            </div>
                        </div>
